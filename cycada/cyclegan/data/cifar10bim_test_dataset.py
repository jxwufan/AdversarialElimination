...
class Cifar10bimTestDataset(BaseDataset):
    def name(self):
        return 'Cifar10bimTestDataset'
	...
	y_test = y_test.reshape([-1]).astype('int64')
        ...
        self.cifar10bim = np.concatenate((x_adv_test, x_test))
        self.cifar10bim_label = np.concatenate((y_test, y_test))
