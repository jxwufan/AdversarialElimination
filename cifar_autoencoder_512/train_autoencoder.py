...
fg_train, fg_test = pickle.load(open("/data/cifar/fg.pkl"))

input_data = np.concatenate([fg_train, x_train], axis=0)
output_data = np.concatenate([x_train, x_train], axis=0)

validation_input_data = np.concatenate([fg_test, x_test], axis=0)
...
autoencoder.save("autoencoder_fg.h5")
